...
if True:
    ...
    def create_buwindow():
        ...
        tk.Label(buwin, text="バックアップ先ドライブ：", font=("", 12)).place(
            x=20, y=20
        )
        ...
        bu_frame = ttk.Labelframe(
            buwin, text="バックアップ対象選択", width=320, height=80
        )
